...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Update ": "Add New " ?>Vaccine Process Details</h3>
	</div>
	<div class="card-body">
            ...
            <div class="form-group row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-sm rounded-0" id="lastname" required name="firstname" value="<?php echo isset($lastname) ? $firstname :'' ?>">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="firstname" class="control-label">Middle Name</label>
                        <input type="text" class="form-control form-control-sm rounded-0" id="firstname" required name="middlename" value="<?php echo isset($firstname) ? $middlename :'' ?>">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="middlename" class="control-label">Last Name</label>
                        <input type="text" class="form-control form-control-sm rounded-0" id="middlename" required name="lastname" value="<?php echo isset($middlename) ? $lastname :'' ?>">
                    </div>
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
				<div class="col-md-6">
					...
					<select name="status" id="status" class="custom-select selevt" required>
						...
						<option value="1" <?php echo isset($status) && $status >= 1 ? 'selected' : '' ?>>Vaccinated</option>
